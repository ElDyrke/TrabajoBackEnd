...
urlpatterns = [
    ...
    path('editarDestinos/<int:id>', views.editarDestinos, name="editarDestinos"),
    path('editarViajes/<int:id>', views.editarViajes, name="editarViajes"),
    path('editarCotizaciones/<int:id>', views.editarCotizaciones, name="editarCotizaciones"),
    path('editarReservas/<int:id>', views.editarReservas, name="editarReservas"),
